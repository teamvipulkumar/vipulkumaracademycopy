...
const ELEMENT_HTML: Record<string, string> = {
  ...
  footer: `<p style="font-size:12px;color:#9ca3af;text-align:center;border-top:1px solid #e5e7eb;padding-top:16px;margin:20px 0 0;">© 2025 ClickOcean · All rights reserved<br><a href="#" style="color:#9ca3af;">Privacy Policy</a>&nbsp;·&nbsp;<a href="#" style="color:#9ca3af;">Terms of Service</a></p>`,
};
